...
class MainActivity : AppCompatActivity() {
    ...
    private fun bindAdapters() {
        ...
        val adapterFrom = ArrayAdapter(this, android.R.layout.simple_list_item_1, list)

        binding.tvFrom.setAdapter(adapterFrom)
        binding.tvFrom.setText(Coin.USD.name, false)

        val itemTxt : String = binding.tvFrom.text.toString()

        val listTo = list.toMutableList()
